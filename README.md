...
#### 🔵 ПРИОРИТЕТ 3: Управление солнечной энергией

**3a. Накопление солнца (`charge_solar`)**

- **Условие:** Избыток солнечной энергии > 100W и батарея < 95%
- **Действие:** Зарядка батареи от солнечных панелей

**3b. Экспорт солнца (`export_solar`)**

- **Условие:** Избыток солнечной энергии > 100W и батарея ≥ 95%
- **Действие:** Экспорт избытков в сеть

#### 🟠 ПРИОРИТЕТ 4: Покрытие нагрузки (`discharge_load`)

**Условия:**

- ✅ Чистое потребление > 100W (дом нуждается в энергии)
- ✅ Доступно > 500Wh в батарее
- ✅ Нет солнечного избытка

**Действие:** Разрядка батареи для покрытия бытовых нужд
...
| ------------------------------- | -------- | --------------------------------- |
| **Min Arbitrage Margin**        | 5%       | Минимальная прибыль для арбитража |
| **Max Daily Cycles**            | 2.0      | Защита батареи от износа          |
| **Min Arbitrage Depth**         | 40%      | Минимальный уровень для арбитража |
| **Surplus Threshold**           | 100W     | Порог избытка солнечной энергии   |
| **Net Consumption Threshold**   | 100W     | Порог дефицита энергии            |
| **Available Battery Threshold** | 500Wh    | Минимум для разрядки на нагрузку  |
